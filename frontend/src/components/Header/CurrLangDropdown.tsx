      ...
      <div className="grid gap-6 lg:grid-cols-2">
        {languages.map((item, index) => (
            <button
                ...
                className={clsx(
                    '-m-2.5 w-full text-left flex items-center rounded-lg p-2.5 transition duration-150 ease-in-out hover:bg-neutral-100 focus:outline-hidden dark:hover:bg-neutral-700',
